    ...
    <>
      ...
      <div className="w-11/12 md:w-9/12 m-auto grid grid-cols-2 gap-4 h-[550px] my-10">
        <div className="grid grid-cols-2 gap-4">
          <div className="rounded-lg overflow-hidden relative group col-span-2">
            <img
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="rounded-lg overflow-hidden relative group row-start-2 col-start-1 col-end-4">
            <img
